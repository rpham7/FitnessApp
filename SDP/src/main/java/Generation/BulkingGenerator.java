...
public final class BulkingGenerator {
    @NotNull
    private Bulking Bulking;
    @NotNull
    ...
    public BulkingGenerator(@NotNull Bulking Bulking, @NotNull User user) {
        this.nutrients = "Reminder to consume more calories than normal!";
    ...
    @NotNull
    public final Bulking getBulking() {
        return this.Bulking;
    }

    public final void setBulking(@NotNull Bulking var1) {
    ...
    public final void generate() {
        List temp = this.Bulking.getUserList();
