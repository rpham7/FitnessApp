...
public final class CuttingGenerator {
    @NotNull
    ...
    public CuttingGenerator(@NotNull Cutting Cutting, @NotNull User user) {
    ...
    @NotNull
    public final Cutting getCutting() {
        return this.Cutting;
    }

    public final void setCutting(@NotNull Cutting var1) {
    ...
    public final void generate() {
        List temp = this.Cutting.getUserList();
